...
- [Основы языка (Python vs Go)](#Основы-языка-(Python-vs-Go))  
    - [Переменные и типы (Python vs Go)](#Переменные-и-типы-(Python-vs-Go))  
    - [Условия (if / else)](#Условия-(if-/-else))  
    - [Циклы](#Циклы)  
    - [Функции (Python vs Go)](#Функции-(Python-vs-Go))  
    - [Списки и массивы (Python vs Go)](#Списки-и-массивы-(Python-vs-Go))  
...
### Переменные и типы (Python vs Go)
